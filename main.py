...
def _chat_mode(interrupt_queue: queue.Queue, previous_summary: str = "") -> str:
    ...
    chat_system = (
        ...
        "CRITICAL: When CJ uses a word or term you don't recognize — ASK. Don't invent a definition.\n"
        "  CJ: 'what about the mynthos model'\n"
        "  You: 'never heard of it. what is that?'\n"
        "NOT: 'oh yeah, Mythos mode is great for storytelling' — that's making stuff up.\n"
        "If you're not certain something is real, say so. Use search_web() if you need to check.\n"
        "Don't double down on a guess to seem knowledgeable. Admit when you don't know.\n\n"
